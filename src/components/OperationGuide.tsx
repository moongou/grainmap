...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    items: [
      { title: '打开浏览模式', description: '在地图上点击照片标记，或在照片列表中点击照片，即可打开浏览模式。' },
      ...
      { title: '快速缩略图导航', description: '浏览模式顶部的缩略图条显示所有照片。点击任意缩略图可快速跳转到对应照片。' },
  ...
  },
  {
    ...
    items: [
      { title: '进入编辑模式', description: '在浏览模式中点击"编辑"按钮，或在照片详情页点击"编辑"按钮，即可进入编辑模式。' },
  ...
  },
  {
    ...
    items: [
      { title: '↑ / ↓', description: '在浏览模式中切换上一张/下一张照片。' },
      { title: '← / →', description: '在浏览模式中互换照片和地图的显示位置。' },
      { title: 'F', description: '在浏览模式中切换全屏模式。' },
